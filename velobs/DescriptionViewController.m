...
- (void)viewDidLoad {
    ...
    if (screenBounds.size.height == 480) {
        ...
        labelExplicatif.text = @"Étape 4/6\nDescription de l'observation";
        ...
        champDescription = [[UITextView alloc] initWithFrame:CGRectMake(20, 190, 280, 120)];
        champDescription.backgroundColor =  [UIColor colorWithRed:245.0/255.0 \
                                                         green:245.0/255.0 \
                                                          blue:245.0/255.0 \
                                                         alpha:1.0];;
        
        champDescription.keyboardType = UIKeyboardTypeDefault ;
        [champDescription setFont:[UIFont systemFontOfSize:15]];
        champDescription.delegate = self;
        [self.scrollView addSubview:champDescription];
        ...
        champDescription = [[UITextView alloc] initWithFrame:CGRectMake(20, 210, 280, 120)];
        champDescription.backgroundColor =  [UIColor colorWithRed:245.0/255.0 \
                                                            green:245.0/255.0 \
                                                             blue:245.0/255.0 \
                                                            alpha:1.0];;
        ...
        champDescription = [[UITextView alloc] initWithFrame:CGRectMake(24, 248, 327, 140)];
        champDescription.backgroundColor =  [UIColor colorWithRed:245.0/255.0 \
                                                            green:245.0/255.0 \
                                                             blue:245.0/255.0 \
                                                            alpha:1.0];;
        ...
        champDescription = [[UITextView alloc] initWithFrame:CGRectMake(26, 271, 362, 159)];
        champDescription.backgroundColor =  [UIColor colorWithRed:245.0/255.0 \
                                                            green:245.0/255.0 \
                                                             blue:245.0/255.0 \
                                                            alpha:1.0];;
...
-(void) suivant:(id)sender {
    ...
    NSString *temp = [NSString stringWithFormat:@"%@",champDescription.text];
   
    [[VelObsSingleton sharedPref] setObservation:temp];
    
    PropositionViewController *propViewController = [[PropositionViewController alloc] init];
    [self.navigationController pushViewController:propViewController animated:YES ] ;
